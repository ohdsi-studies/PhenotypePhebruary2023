...
outputFolder <- "D:/studyResults/phenotypePhebruary2023"
...
cohortTable <- "phenotypePhebruary2023"
...
phenotypePhebruary2023::execute(
...
privateKeyFileName <- ""
userName <- ""
phenotypePhebruary2023::uploadResults(outputFolder, privateKeyFileName, userName)
