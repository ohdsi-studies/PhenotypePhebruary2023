...
#
# This file is part of phenotypePhebruary2023
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("phenotypePhebruary2023")
...
OhdsiRTools::createRenvLockFile(rootPackage = "phenotypePhebruary2023",
                                mode = "description",
